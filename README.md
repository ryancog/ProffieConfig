...
Grab the latest ProffieConfig Launcher from the [download page](https://proffieconfig.kafrenetrading.com/download) and run it!

There's more info and [guides](https://proffieconfig.kafrenetrading.com/guides/) on the website too. :)
