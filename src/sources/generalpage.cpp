...
GeneralPage::GeneralPage(wxWindow* window) : wxStaticBoxSizer(wxVERTICAL, window, "General")
{
    ...
    // propSetup
    {
        ...
        // Stab On
        wxStaticBoxSizer *stabOn = new wxStaticBoxSizer(wxVERTICAL, propSetup->GetStaticBox(), "Stab On");
        settings.stabOn = new wxCheckBox(propSetup->GetStaticBox(), Misc::ID_PropOption, "Stab To Turn On");
        settings.stabOnFast = new wxRadioButton(propSetup->GetStaticBox(), Misc::ID_PropOption, "Fast Ignition", wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
        settings.stabOnPreon = new wxRadioButton(propSetup->GetStaticBox(), Misc::ID_PropOption, "Enable Preon");
        settings.stabOnNoBattle = new wxCheckBox(propSetup->GetStaticBox(), Misc::ID_PropOption, "Do Not Activate BattleMode");
        ...
        // Swing On
        wxStaticBoxSizer *swingOn = new wxStaticBoxSizer(wxVERTICAL, propSetup->GetStaticBox(), "Swing On");
        settings.swingOn = new wxCheckBox(propSetup->GetStaticBox(), Misc::ID_PropOption, "Swing To Turn On");
        settings.swingOnSpeed = Misc::createNumEntry(propSetup, "Swing on Speed", Misc::ID_PropOption, 50, 1000, 250);
        settings.swingOnFast = new wxRadioButton(propSetup->GetStaticBox(), Misc::ID_PropOption, "Fast Ignition", wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
        settings.swingOnPreon = new wxRadioButton(propSetup->GetStaticBox(), Misc::ID_PropOption, "Enable Preon");
        settings.swingOnNoBattle = new wxCheckBox(propSetup->GetStaticBox(), Misc::ID_PropOption, "Do Not Activate BattleMode");
        ...
        // Thrust On
        wxStaticBoxSizer *thrustOn = new wxStaticBoxSizer(wxVERTICAL, propSetup->GetStaticBox(), "Thrust On");
        settings.thrustOn = new wxCheckBox(propSetup->GetStaticBox(), Misc::ID_PropOption, "Thrust To Turn On");
        settings.thrustOnFast = new wxRadioButton(propSetup->GetStaticBox(), Misc::ID_PropOption, "Fast Ignition", wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
        settings.thrustOnPreon = new wxRadioButton(propSetup->GetStaticBox(), Misc::ID_PropOption, "Enable Preon");
        settings.thrustOnNoBattle = new wxCheckBox(propSetup->GetStaticBox(), Misc::ID_PropOption, "Do Not Activate BattleMode");
        ...
        // Twist On
        wxStaticBoxSizer *twistOn = new wxStaticBoxSizer(wxVERTICAL, propSetup->GetStaticBox(), "Twist On");
        settings.twistOn = new wxCheckBox(propSetup->GetStaticBox(), Misc::ID_PropOption, "Twist To Turn On");
        settings.twistOnFast = new wxRadioButton(propSetup->GetStaticBox(), Misc::ID_PropOption, "Fast Ignition", wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
        settings.twistOnPreon = new wxRadioButton(propSetup->GetStaticBox(), Misc::ID_PropOption, "Enable Preon");
        settings.twistOnNoBattle = new wxCheckBox(propSetup->GetStaticBox(), Misc::ID_PropOption, "Do Not Activate BattleMode");
        ...
        // Twist Off
        wxStaticBoxSizer *twistOff = new wxStaticBoxSizer(wxVERTICAL, propSetup->GetStaticBox(), "Twist Off");
        settings.twistOff = new wxCheckBox(propSetup->GetStaticBox(), Misc::ID_PropOption, "Twist To Turn Off");
        settings.twistOffNoPostOff = new wxCheckBox(propSetup->GetStaticBox(), Misc::ID_PropOption, "Disable Postoff");
        twistOff->Add(settings.twistOff, MENUITEMFLAGS);
        twistOff->Add(settings.twistOffNoPostOff, MENUITEMFLAGS);
        ...
        */
        ...
        // Prop Setup 1
        propSetup1->Add(stabOn, MENUITEMFLAGS.Expand());
        propSetup1->Add(swingOn, MENUITEMFLAGS.Expand());
        propSetup1->Add(thrustOn, MENUITEMFLAGS.Expand());
        propSetup1->Add(twistOn, MENUITEMFLAGS.Expand());
        propSetup1->Add(twistOff, MENUITEMFLAGS.Expand());
        // Prop Setup 2
        //propSetup2->Add(settings.disableGuestureNoBlade, MENUITEMFLAGS);
        propSetup2->Add(settings.noLockupHold, MENUITEMFLAGS);
        propSetup2->Add(settings.forcePush, MENUITEMFLAGS);
        propSetup2->Add(settings.forcePushLength.box, MENUITEMFLAGS);
        // Battle Mode
        ...
        propSetup->Add(propSetup1, wxSizerFlags(0));
        propSetup->Add(propSetup2, wxSizerFlags(0));
    }
...
#define ALL SA22C || FETT263 || BC || SHTOK || CAIWYN
    ...
    settings.twistOffNoPostOff->Show(FETT263);
