...
void BladesPage::update() {
    ...
    if (Configuration::instance->blades.size() > 0 && lastBladeSelection >= 0 && lastBladeSelection < (int32_t)Configuration::instance->blades.size()) {
        ...
        settings.star1Color->SetValue(Configuration::instance->blades[lastBladeSelection].Cree1);
        settings.star1Resistance->num->SetValue(Configuration::instance->blades[lastBladeSelection].Cree1Resistance);
        settings.star2Color->SetValue(Configuration::instance->blades[lastBladeSelection].Cree2);
        settings.star2Resistance->num->SetValue(Configuration::instance->blades[lastBladeSelection].Cree2Resistance);
        settings.star3Color->SetValue(Configuration::instance->blades[lastBladeSelection].Cree3);
        settings.star3Resistance->num->SetValue(Configuration::instance->blades[lastBladeSelection].Cree3Resistance);
        settings.star4Color->SetValue(Configuration::instance->blades[lastBladeSelection].Cree4);
