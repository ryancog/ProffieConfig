...
void Configuration::updatePropConfig() {
  ...
  //Configuration::propConfig.battleMode = PropPage::settings.battleEnable->GetValue();
  Configuration::propConfig.gestureBattle = PropPage::settings.gestureEnBattle->GetValue();
  Configuration::propConfig.revertLockup = PropPage::settings.noLockupHold->GetValue();
