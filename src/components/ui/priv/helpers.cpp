 ...
 *
 * components/ui/declarative/priv/helpers.cpp
 *
...
void pcui::declarative::priv::apply(const ChildBase& desc, wxSizerItem *item) {
...
void pcui::declarative::priv::apply(
    const ChildWindowBase& desc, wxSizerItem *item
) {
